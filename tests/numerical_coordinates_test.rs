...
fn test_coord_transform_basic() {
    ...
    let res = numerical_transform_point_pure(&p, CoordinateSystem::Cartesian, CoordinateSystem::Cylindrical).unwrap();
...
fn test_coord_transform_spherical() {
    ...
    let p = vec![1.0, 1.0, 1.0];
    let res = numerical_transform_point_pure(&p, CoordinateSystem::Cartesian, CoordinateSystem::Spherical).unwrap();
...
fn test_coord_jacobian() {
    ...
    let jac = numerical_coordinates_jacobian(CoordinateSystem::Cartesian, CoordinateSystem::Cylindrical, &p).unwrap();
...
fn test_coord_transform_symbolic_assisted() {
    ...
    let p = vec![1.0, 0.0, 0.0];
    let res = numerical_transform_point(&p, CoordinateSystem::Cartesian, CoordinateSystem::Spherical).unwrap();
