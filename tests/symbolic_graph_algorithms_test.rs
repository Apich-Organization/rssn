...
fn test_bipartite_maximum_matching() {
    ...
    g.add_node(3); g.add_node(4); g.add_node(5);
...
fn test_min_cost_max_flow() {
    ...
    g.add_edge(&0, &1, Expr::Tuple(vec![Expr::Constant(10.0), Expr::Constant(2.0)]));
    g.add_edge(&0, &2, Expr::Tuple(vec![Expr::Constant(10.0), Expr::Constant(4.0)]));
    g.add_edge(&1, &3, Expr::Tuple(vec![Expr::Constant(5.0), Expr::Constant(1.0)]));
    g.add_edge(&2, &3, Expr::Tuple(vec![Expr::Constant(5.0), Expr::Constant(3.0)]));
