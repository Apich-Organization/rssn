...
fn test_transform_point_cylindrical_to_cartesian_symbolic() {
    ...
    let cart_point = transform_point(&cyl_point, CoordinateSystem::Cylindrical, CoordinateSystem::Cartesian).unwrap();
...
fn test_transform_point_spherical_to_cartesian_symbolic() {
    ...
    let cart_point = transform_point(&sph_point, CoordinateSystem::Spherical, CoordinateSystem::Cartesian).unwrap();
...
fn test_transform_expression_symbolic() {
    ...
    let f_cart = transform_expression(&f, CoordinateSystem::Cylindrical, CoordinateSystem::Cartesian).unwrap();
...
fn test_coordinate_system_identity() {
    ...
    let result = transform_point(&point, CoordinateSystem::Cartesian, CoordinateSystem::Cartesian).unwrap();
