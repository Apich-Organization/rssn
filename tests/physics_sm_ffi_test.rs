...
fn test_sm_simulate_1d_handle_ffi() {
    unsafe {
        let matrix_ptr = rssn::ffi_apis::physics_sm_ffi::handle::rssn_physics_sm_simulate_1d_advection();
...
fn test_sm_solve_2d_json_ffi() {
    ...
    unsafe {
        let res_ptr = rssn::ffi_apis::physics_sm_ffi::json::rssn_physics_sm_solve_advection_2d_json(c_input.as_ptr());
