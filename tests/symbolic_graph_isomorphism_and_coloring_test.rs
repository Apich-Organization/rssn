...
fn test_greedy_coloring_bipartite() {
    ...
    g.add_edge(&3, &0, Expr::Constant(1.0));
...
fn test_chromatic_number_exact_petersen() {
    ...
    g.add_edge(&4, &0, Expr::Constant(1.0));
    // Inner star
    g.add_edge(&5, &7, Expr::Constant(1.0));
    g.add_edge(&7, &9, Expr::Constant(1.0));
    g.add_edge(&9, &6, Expr::Constant(1.0));
    g.add_edge(&6, &8, Expr::Constant(1.0));
    g.add_edge(&8, &5, Expr::Constant(1.0));
    // Spokes
    g.add_edge(&0, &5, Expr::Constant(1.0));
    g.add_edge(&1, &6, Expr::Constant(1.0));
    g.add_edge(&2, &7, Expr::Constant(1.0));
    g.add_edge(&3, &8, Expr::Constant(1.0));
    g.add_edge(&4, &9, Expr::Constant(1.0));
