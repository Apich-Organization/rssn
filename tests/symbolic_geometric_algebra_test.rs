...
fn test_geometric_product_vectors() {
    let signature = (3, 0, 0);
    // e1
    let v1 = Multivector::vector(signature, vec![Expr::Constant(1.0), Expr::Constant(0.0), Expr::Constant(0.0)]);
    // e2
    let v2 = Multivector::vector(signature, vec![Expr::Constant(0.0), Expr::Constant(1.0), Expr::Constant(0.0)]);
...
fn test_inner_product() {
    let signature = (3, 0, 0);
    let v1 = Multivector::vector(signature, vec![Expr::Constant(1.0), Expr::Constant(0.0), Expr::Constant(0.0)]);
    let v2 = Multivector::vector(signature, vec![Expr::Constant(1.0), Expr::Constant(0.0), Expr::Constant(0.0)]);
...
fn test_reverse_vector() {
    let signature = (3, 0, 0);
    let v = Multivector::vector(signature, vec![Expr::Constant(1.0), Expr::Constant(2.0), Expr::Constant(3.0)]);
...
fn test_magnitude() {
    let signature = (3, 0, 0);
    let v = Multivector::vector(signature, vec![Expr::Constant(3.0), Expr::Constant(4.0), Expr::Constant(0.0)]);
...
fn test_dual() {
    let signature = (3, 0, 0);
    let v = Multivector::vector(signature, vec![Expr::Constant(1.0), Expr::Constant(0.0), Expr::Constant(0.0)]);
...
fn test_geometric_product_associativity() {
    ...
    let result1 = v1.clone().geometric_product(&v2.clone()).geometric_product(&v3.clone());
