...
rssn_ void numerical_optimize_drop_result_handle(rssn_FfiOptimizationResult *aHandle) ;

rssn_ void numerical_optimize_free_json(char *aPtr) ;

rssn_ double numerical_optimize_get_result_cost_handle(const rssn_FfiOptimizationResult *aHandle) ;
...
rssn_ rssn_BincodeBuffer numerical_optimize_solve_bincode(rssn_BincodeBuffer aBuffer) ;
 ...
 */
rssn_ rssn_Expr *rssn_bessel_i(const rssn_Expr *aOrder, const rssn_Expr *aArg) ;
 ...
 */
rssn_ rssn_Expr *rssn_bessel_j(const rssn_Expr *aOrder, const rssn_Expr *aArg) ;
 ...
 */
rssn_ rssn_Expr *rssn_bessel_k(const rssn_Expr *aOrder, const rssn_Expr *aArg) ;
 ...
 */
rssn_ rssn_Expr *rssn_bessel_y(const rssn_Expr *aOrder, const rssn_Expr *aArg) ;
 ...
 */
rssn_ rssn_Expr *rssn_beta(const rssn_Expr *aA, const rssn_Expr *aB) ;
 ...
 */
rssn_ rssn_Vector *rssn_bezier_curve_evaluate(const rssn_BezierCurve *aCurve, const rssn_Expr *aT) ;

/*
 Frees a Bezier curve.
 */
rssn_ void rssn_bezier_curve_free(rssn_BezierCurve *aCurve) ;

/*
 Creates a new Bezier curve from control points.
 */
rssn_ rssn_BezierCurve *rssn_bezier_curve_new(const rssn_Vector *aPoints, size_t aCount) ;
 ...
 */
rssn_ rssn_BincodeBuffer rssn_bincode_bessel_i0(rssn_BincodeBuffer aValBuf) ;

/*
 Computes I₁(x) via Bincode interface.
 */
rssn_ rssn_BincodeBuffer rssn_bincode_bessel_i1(rssn_BincodeBuffer aValBuf) ;
 ...
 */
rssn_ rssn_BincodeBuffer rssn_bincode_bessel_j0(rssn_BincodeBuffer aValBuf) ;

/*
 Computes J₁(x) via Bincode interface.
 */
rssn_ rssn_BincodeBuffer rssn_bincode_bessel_j1(rssn_BincodeBuffer aValBuf) ;
 ...
 */
rssn_ rssn_BincodeBuffer rssn_bincode_bessel_k0(rssn_BincodeBuffer aValBuf) ;

/*
 Computes K₁(x) via Bincode interface.
 */
rssn_ rssn_BincodeBuffer rssn_bincode_bessel_k1(rssn_BincodeBuffer aValBuf) ;
 ...
 */
rssn_ rssn_BincodeBuffer rssn_bincode_bessel_y0(rssn_BincodeBuffer aValBuf) ;

/*
 Computes Y₁(x) via Bincode interface.
 */
rssn_ rssn_BincodeBuffer rssn_bincode_bessel_y1(rssn_BincodeBuffer aValBuf) ;

rssn_ rssn_BincodeBuffer rssn_bincode_beta(rssn_BincodeBuffer aABuf, rssn_BincodeBuffer aBBuf) ;
 ...
 */
rssn_ rssn_BincodeBuffer rssn_bincode_binomial(rssn_BincodeBuffer aNBuf, rssn_BincodeBuffer aKBuf) ;
...
/*
 ...
 Returns: u32
 */
rssn_ rssn_BincodeBuffer rssn_bincode_crc32_compute(rssn_BincodeBuffer aDataBuf) ;
 ...
 */
rssn_ rssn_BincodeBuffer rssn_bincode_crc32_finalize(rssn_BincodeBuffer aCrcBuf) ;
 ...
 */
rssn_ rssn_BincodeBuffer rssn_bincode_curve_point_infinity() ;
...
rssn_ rssn_BincodeBuffer rssn_bincode_digamma(rssn_BincodeBuffer aArgBuf) ;

/*
 Computes ψ(x) via Bincode interface.
 */
rssn_ rssn_BincodeBuffer rssn_bincode_digamma_numerical(rssn_BincodeBuffer aValBuf) ;
 ...
 */
rssn_ rssn_BincodeBuffer rssn_bincode_double_factorial(rssn_BincodeBuffer aNBuf) ;
...
rssn_ rssn_BincodeBuffer rssn_bincode_erf(rssn_BincodeBuffer aArgBuf) ;

/*
 Computes erf(x) via Bincode interface.
 */
rssn_ rssn_BincodeBuffer rssn_bincode_erf_numerical(rssn_BincodeBuffer aValBuf) ;

rssn_ rssn_BincodeBuffer rssn_bincode_erfc(rssn_BincodeBuffer aArgBuf) ;

/*
 Computes erfc(x) via Bincode interface.
 */
rssn_ rssn_BincodeBuffer rssn_bincode_erfc_numerical(rssn_BincodeBuffer aValBuf) ;
...
/*
 Computes n! via Bincode interface.
 */
rssn_ rssn_BincodeBuffer rssn_bincode_factorial(rssn_BincodeBuffer aNBuf) ;
 ...
 */
rssn_ rssn_BincodeBuffer rssn_bincode_gamma_numerical(rssn_BincodeBuffer aValBuf) ;
...
/*
 ...
 Returns: bool
 */
rssn_ rssn_BincodeBuffer rssn_bincode_hamming_check(rssn_BincodeBuffer aCodewordBuf) ;

/*
 Decodes a 7-bit Hamming(7,4) codeword via Bincode interface.
 Returns tuple of (data, error_pos).
 */
rssn_ rssn_BincodeBuffer rssn_bincode_hamming_decode(rssn_BincodeBuffer aCodewordBuf) ;
 ...
 */
rssn_ rssn_BincodeBuffer rssn_bincode_hamming_encode(rssn_BincodeBuffer aDataBuf) ;
...
/*
 ...
 Returns: usize
 */
rssn_ rssn_BincodeBuffer rssn_bincode_hamming_weight(rssn_BincodeBuffer aDataBuf) ;
...
/*
 Computes erf⁻¹(x) via Bincode interface.
 */
rssn_ rssn_BincodeBuffer rssn_bincode_inverse_erf(rssn_BincodeBuffer aValBuf) ;

/*
 Computes erfc⁻¹(x) via Bincode interface.
 */
rssn_ rssn_BincodeBuffer rssn_bincode_inverse_erfc(rssn_BincodeBuffer aValBuf) ;
 ...
 */
rssn_ rssn_BincodeBuffer rssn_bincode_ln_factorial(rssn_BincodeBuffer aNBuf) ;

rssn_ rssn_BincodeBuffer rssn_bincode_ln_gamma(rssn_BincodeBuffer aArgBuf) ;
...
/*
 Compresses a point.
 */
rssn_ rssn_BincodeBuffer rssn_bincode_point_compress(rssn_BincodeBuffer aPointBuf) ;
 ...
 */
rssn_ rssn_BincodeBuffer rssn_bincode_reflection_2d(rssn_BincodeBuffer aAngleBuf) ;
 ...
 */
rssn_ rssn_BincodeBuffer rssn_bincode_rotation_2d(rssn_BincodeBuffer aAngleBuf) ;

/*
 Generates a 4x4 3D rotation matrix around X-axis via Bincode interface.
 */
rssn_ rssn_BincodeBuffer rssn_bincode_rotation_3d_x(rssn_BincodeBuffer aAngleBuf) ;

/*
 Generates a 4x4 3D rotation matrix around Y-axis via Bincode interface.
 */
rssn_ rssn_BincodeBuffer rssn_bincode_rotation_3d_y(rssn_BincodeBuffer aAngleBuf) ;

/*
 Generates a 4x4 3D rotation matrix around Z-axis via Bincode interface.
 */
rssn_ rssn_BincodeBuffer rssn_bincode_rotation_3d_z(rssn_BincodeBuffer aAngleBuf) ;
 ...
 */
rssn_ rssn_BincodeBuffer rssn_bincode_sinc(rssn_BincodeBuffer aValBuf) ;
 ...
 */
rssn_ rssn_BincodeBuffer rssn_bincode_zeta_numerical(rssn_BincodeBuffer aValBuf) ;
 ...
 */
rssn_ size_t rssn_cad_get_cell_count(const rssn_Cad *aPtr) ;
 ...
 */
rssn_ rssn_Expr *rssn_carnot_efficiency(const rssn_Expr *aTc, const rssn_Expr *aTh) ;
 ...
 */
rssn_ rssn_Expr *rssn_chebyshev_t(const rssn_Expr *aN, const rssn_Expr *aX) ;

/*
 Computes the symbolic Chebyshev polynomial of the second kind U_n(x).
 */
rssn_ rssn_Expr *rssn_chebyshev_u(const rssn_Expr *aN, const rssn_Expr *aX) ;
 ...
 */
rssn_ rssn_Vector *rssn_coulombs_law(const rssn_Expr *aCharge, const rssn_Vector *aR) ;
 ...
 */
rssn_ void rssn_crystal_lattice_free(rssn_CrystalLattice *aPtr) ;
 ...
 */
rssn_ rssn_Expr *rssn_crystal_lattice_volume(const rssn_CrystalLattice *aPtr) ;
...
rssn_ bool rssn_curve_is_on_curve(const rssn_EllipticCurve *aCurve, const rssn_CurvePoint *aPoint) ;
 ...
 */
rssn_ void rssn_curve_point_free(rssn_CurvePoint *aPoint) ;

/*
 Gets the x-coordinate of an affine point as a string. Returns NULL if infinity.
 */
rssn_ char *rssn_curve_point_get_x(const rssn_CurvePoint *aPoint) ;

/*
 Gets the y-coordinate of an affine point as a string. Returns NULL if infinity.
 */
rssn_ char *rssn_curve_point_get_y(const rssn_CurvePoint *aPoint) ;

/*
 Creates the point at infinity.
 */
rssn_ rssn_CurvePoint *rssn_curve_point_infinity() ;

/*
 Checks if a point is the point at infinity.
 */
rssn_ bool rssn_curve_point_is_infinity(const rssn_CurvePoint *aPoint) ;
 ...
 */
rssn_ rssn_Expr *rssn_digamma(const rssn_Expr *aArg) ;
 ...
 */
rssn_ rssn_Expr *rssn_dirac_adjoint(const rssn_Expr *aPsi) ;
...
rssn_ void rssn_ecdsa_signature_free(rssn_EcdsaSignature *aSig) ;

rssn_ char *rssn_ecdsa_signature_get_r(const rssn_EcdsaSignature *aSig) ;

rssn_ char *rssn_ecdsa_signature_get_s(const rssn_EcdsaSignature *aSig) ;
 ...
 */
rssn_ void rssn_elliptic_curve_free(rssn_EllipticCurve *aCurve) ;
 ...
 */
rssn_ rssn_Expr *rssn_enthalpy(const rssn_Expr *aU, const rssn_Expr *aP, const rssn_Expr *aV) ;

/*
 Computes the symbolic error function erf(z).
 */
rssn_ rssn_Expr *rssn_erf(const rssn_Expr *aArg) ;
 ...
 */
rssn_ rssn_Expr *rssn_erfc(const rssn_Expr *aArg) ;
...
rssn_ void rssn_expr_list_free(rssn_ExprList *aList) ;

rssn_ rssn_Expr *rssn_expr_list_get(const rssn_ExprList *aList, size_t aIndex) ;

rssn_ size_t rssn_expr_list_len(const rssn_ExprList *aList) ;
 ...
 */
rssn_ rssn_Expr *rssn_feynman_slash(const rssn_Expr *aVMu) ;
...
/*
 Frees a CAD handle.
 */
rssn_ void rssn_free_cad_handle(rssn_Cad *aPtr) ;
 ...
 */
rssn_ rssn_Expr *rssn_gamma(const rssn_Expr *aArg) ;
 ...
 */
rssn_ rssn_Expr *rssn_hall_coefficient(const rssn_Expr *aN, const rssn_Expr *aQ) ;
 ...
 */
rssn_ rssn_Expr *rssn_hermite_h(const rssn_Expr *aDegree, const rssn_Expr *aArg) ;

/*
 Constructs Rodrigues' formula for Hermite polynomials.
 */
rssn_ rssn_Expr *rssn_hermite_rodrigues_formula(const rssn_Expr *aN, const rssn_Expr *aX) ;
 ...
 */
rssn_ char *rssn_json_curve_point_infinity() ;
...
rssn_ rssn_Expr *rssn_laplace_integration(const rssn_Expr *aFS, const char *aOutVar) ;
 ...
 */
rssn_ rssn_Expr *rssn_legendre_p(const rssn_Expr *aDegree, const rssn_Expr *aArg) ;

/*
 Constructs Rodrigues' formula for Legendre polynomials.
 */
rssn_ rssn_Expr *rssn_legendre_rodrigues_formula(const rssn_Expr *aN, const rssn_Expr *aX) ;
 ...
 */
rssn_ rssn_Expr *rssn_ln_gamma(const rssn_Expr *aArg) ;
...
rssn_ rssn_BincodeBuffer rssn_num_comb_bell_bincode(rssn_BincodeBuffer aBuffer) ;
...
rssn_ rssn_BincodeBuffer rssn_num_comb_catalan_bincode(rssn_BincodeBuffer aBuffer) ;
...
rssn_ rssn_BincodeBuffer rssn_num_comb_combinations_bincode(rssn_BincodeBuffer aBuffer) ;
...
rssn_ rssn_BincodeBuffer rssn_num_comb_factorial_bincode(rssn_BincodeBuffer aBuffer) ;
...
rssn_ rssn_BincodeBuffer rssn_num_comb_falling_factorial_bincode(rssn_BincodeBuffer aBuffer) ;
...
rssn_ rssn_BincodeBuffer rssn_num_comb_permutations_bincode(rssn_BincodeBuffer aBuffer) ;
...
rssn_ rssn_BincodeBuffer rssn_num_comb_rising_factorial_bincode(rssn_BincodeBuffer aBuffer) ;
...
rssn_ rssn_BincodeBuffer rssn_num_comb_solve_recurrence_bincode(rssn_BincodeBuffer aBuffer) ;
...
rssn_ rssn_BincodeBuffer rssn_num_comb_stirling_second_bincode(rssn_BincodeBuffer aBuffer) ;
...
rssn_ rssn_BincodeBuffer rssn_num_fa_gram_schmidt_bincode(rssn_BincodeBuffer aBuffer) ;
...
rssn_ rssn_BincodeBuffer rssn_num_fa_inner_product_bincode(rssn_BincodeBuffer aBuffer) ;
...
rssn_ rssn_BincodeBuffer rssn_num_fa_l2_norm_bincode(rssn_BincodeBuffer aBuffer) ;
 ...
 */
rssn_ double rssn_num_fea_material_aluminum_shear_modulus() ;

/*
 Creates copper material and returns shear modulus.
 */
rssn_ double rssn_num_fea_material_copper_shear_modulus() ;
 ...
 */
rssn_ double rssn_num_fea_material_steel_shear_modulus() ;
...
rssn_ rssn_BincodeBuffer rssn_num_fea_principal_stresses_bincode(rssn_BincodeBuffer aBuffer) ;
...
rssn_ rssn_BincodeBuffer rssn_num_fea_von_mises_stress_bincode(rssn_BincodeBuffer aBuffer) ;
...
rssn_ rssn_BincodeBuffer rssn_num_fractal_box_counting_dim_bincode(rssn_BincodeBuffer aBuffer) ;
...
rssn_ rssn_BincodeBuffer rssn_num_fractal_correlation_dim_bincode(rssn_BincodeBuffer aBuffer) ;
...
rssn_ rssn_BincodeBuffer rssn_num_fractal_henon_map_bincode(rssn_BincodeBuffer aBuffer) ;
...
rssn_ rssn_BincodeBuffer rssn_num_fractal_julia_set_bincode(rssn_BincodeBuffer aBuffer) ;
...
rssn_ rssn_BincodeBuffer rssn_num_fractal_logistic_map_bincode(rssn_BincodeBuffer aBuffer) ;
...
rssn_ rssn_BincodeBuffer rssn_num_fractal_lorenz_attractor_bincode(rssn_BincodeBuffer aBuffer) ;
...
rssn_ rssn_BincodeBuffer rssn_num_fractal_lyapunov_logistic_bincode(rssn_BincodeBuffer aBuffer) ;
...
rssn_ rssn_BincodeBuffer rssn_num_fractal_mandelbrot_set_bincode(rssn_BincodeBuffer aBuffer) ;
 ...
 */
rssn_ rssn_BincodeBuffer rssn_num_ga_add_bincode(rssn_BincodeBuffer aBuffer) ;
 ...
 */
rssn_ rssn_BincodeBuffer rssn_num_ga_dot_bincode(rssn_BincodeBuffer aBuffer) ;
 ...
 */
rssn_ void rssn_num_ga_free(rssn_Multivector3D *aMv) ;
 ...
 */
rssn_ rssn_Multivector3D *rssn_num_ga_inv(const rssn_Multivector3D *aMv) ;

/*
 Bincode FFI for ga_inv.
 */
rssn_ rssn_BincodeBuffer rssn_num_ga_inv_bincode(rssn_BincodeBuffer aBuffer) ;
 ...
 */
rssn_ rssn_BincodeBuffer rssn_num_ga_mul_bincode(rssn_BincodeBuffer aBuffer) ;
 ...
 */
rssn_ double rssn_num_ga_norm(const rssn_Multivector3D *aMv) ;

/*
 Bincode FFI for ga_norm.
 */
rssn_ rssn_BincodeBuffer rssn_num_ga_norm_bincode(rssn_BincodeBuffer aBuffer) ;
 ...
 */
rssn_ rssn_Multivector3D *rssn_num_ga_reverse(const rssn_Multivector3D *aMv) ;

/*
 Bincode FFI for ga_reverse.
 */
rssn_ rssn_BincodeBuffer rssn_num_ga_reverse_bincode(rssn_BincodeBuffer aBuffer) ;
 ...
 */
rssn_ rssn_BincodeBuffer rssn_num_ga_sub_bincode(rssn_BincodeBuffer aBuffer) ;
 ...
 */
rssn_ rssn_BincodeBuffer rssn_num_ga_wedge_bincode(rssn_BincodeBuffer aBuffer) ;
...
rssn_ rssn_BincodeBuffer rssn_num_graphics_cross_product_bincode(rssn_BincodeBuffer aBuffer) ;
...
rssn_ rssn_BincodeBuffer rssn_num_graphics_dot_product_bincode(rssn_BincodeBuffer aBuffer) ;
...
rssn_ rssn_BincodeBuffer rssn_num_graphics_normalize_bincode(rssn_BincodeBuffer aBuffer) ;
...
rssn_ rssn_BincodeBuffer rssn_num_graphics_quaternion_multiply_bincode(rssn_BincodeBuffer aBuffer) ;
...
rssn_ rssn_BincodeBuffer rssn_num_graphics_rotation_matrix_x_bincode(rssn_BincodeBuffer aBuffer) ;
...
rssn_ rssn_BincodeBuffer rssn_num_graphics_translation_matrix_bincode(rssn_BincodeBuffer aBuffer) ;
 ...
 */
rssn_ rssn_BincodeBuffer rssn_num_matrix_add_bincode(const uint8_t *aData, size_t aLen) ;
 ...
 */
rssn_ rssn_Matrix<double> *rssn_num_matrix_create(size_t aRows, size_t aCols, const double *aData) ;
...
rssn_ int32_t rssn_num_matrix_determinant(const rssn_Matrix<double> *aMatrix, double *aResult) ;

rssn_ void rssn_num_matrix_free(rssn_Matrix<double> *aMatrix) ;

/*
 Returns the Frobenius norm.
 */
rssn_ double rssn_num_matrix_frobenius_norm(const rssn_Matrix<double> *aMatrix) ;

rssn_ size_t rssn_num_matrix_get_cols(const rssn_Matrix<double> *aMatrix) ;

rssn_ int32_t rssn_num_matrix_get_data(const rssn_Matrix<double> *aMatrix, double *aBuffer) ;

rssn_ size_t rssn_num_matrix_get_rows(const rssn_Matrix<double> *aMatrix) ;

/*
 Creates an identity matrix.
 */
rssn_ rssn_Matrix<double> *rssn_num_matrix_identity(size_t aSize) ;

rssn_ rssn_Matrix<double> *rssn_num_matrix_inverse(const rssn_Matrix<double> *aMatrix) ;

/*
 Checks if it's identity.
 */
rssn_ int32_t rssn_num_matrix_is_identity(const rssn_Matrix<double> *aMatrix, double aEpsilon) ;

/*
 Checks if it's orthogonal.
 */
rssn_ int32_t rssn_num_matrix_is_orthogonal(const rssn_Matrix<double> *aMatrix, double aEpsilon) ;

rssn_
rssn_Matrix<double> *rssn_num_matrix_mul(const rssn_Matrix<double> *aM1,
                                         const rssn_Matrix<double> *aM2)
;
 ...
 */
rssn_ rssn_BincodeBuffer rssn_num_matrix_mul_bincode(const uint8_t *aData, size_t aLen) ;
...
/*
 Returns the rank.
 */
rssn_ int32_t rssn_num_matrix_rank(const rssn_Matrix<double> *aMatrix, size_t *aOutRank) ;
...
rssn_ rssn_BincodeBuffer rssn_num_md_apply_pbc_bincode(rssn_BincodeBuffer aBuffer) ;
 ...
 */
rssn_ double rssn_num_md_avogadro_number() ;

/*
 Returns Boltzmann constant in SI units.
 */
rssn_ double rssn_num_md_boltzmann_constant_si() ;
...
rssn_ rssn_BincodeBuffer rssn_num_md_lennard_jones_bincode(rssn_BincodeBuffer aBuffer) ;
 ...
 */
rssn_ double rssn_num_md_temperature_unit_argon() ;
 ...
 */
rssn_ rssn_BincodeBuffer rssn_num_nt_factorize_bincode(const uint8_t *aData, size_t aLen) ;
...
rssn_ rssn_BincodeBuffer rssn_num_ode_solve_bincode(rssn_BincodeBuffer aBuffer) ;
...
rssn_ double rssn_num_physics_boltzmann_constant() ;
...
rssn_ rssn_BincodeBuffer rssn_num_physics_coulomb_force_bincode(rssn_BincodeBuffer aBuffer) ;
...
rssn_ double rssn_num_physics_electron_mass() ;

rssn_ double rssn_num_physics_elementary_charge() ;

rssn_ double rssn_num_physics_gravitational_constant() ;
...
rssn_ rssn_BincodeBuffer rssn_num_physics_ideal_gas_pressure_bincode(rssn_BincodeBuffer aBuffer) ;
...
rssn_ rssn_BincodeBuffer rssn_num_physics_lorentz_factor_bincode(rssn_BincodeBuffer aBuffer) ;
...
rssn_ rssn_BincodeBuffer rssn_num_physics_mass_energy_bincode(rssn_BincodeBuffer aBuffer) ;
...
rssn_ double rssn_num_physics_planck_constant() ;
...
rssn_ double rssn_num_physics_speed_of_light() ;
 ...
 */
rssn_ rssn_BincodeBuffer rssn_num_sparse_spmv_bincode(const uint8_t *aData, size_t aLen) ;
 ...
 */
rssn_ rssn_BincodeBuffer rssn_num_tensor_tensordot_bincode(const uint8_t *aData, size_t aLen) ;
 ...
 */
rssn_ rssn_BincodeBuffer rssn_numerical_quadrature_bincode(rssn_BincodeBuffer aBuffer) ;
...
rssn_ rssn_BincodeBuffer rssn_numerical_sum_series_bincode(rssn_BincodeBuffer aBuffer) ;
...
rssn_ rssn_BincodeBuffer rssn_numerical_taylor_coefficients_bincode(rssn_BincodeBuffer aBuffer) ;
...
rssn_ rssn_ExprList *rssn_partial_fraction_decomposition(const rssn_Expr *aExpr, const char *aVar) ;
...
rssn_ rssn_BincodeBuffer rssn_physics_bem_solve_laplace_2d_bincode(rssn_BincodeBuffer aBuffer) ;
...
rssn_ rssn_BincodeBuffer rssn_physics_cnm_solve_heat_2d_bincode(rssn_BincodeBuffer aBuffer) ;
...
rssn_ rssn_BincodeBuffer rssn_physics_fem_solve_poisson_1d_bincode(rssn_BincodeBuffer aBuffer) ;
...
rssn_ rssn_BincodeBuffer rssn_physics_mtm_solve_poisson_2d_bincode(rssn_BincodeBuffer aBuffer) ;
 ...
 */
rssn_ void rssn_physics_sim_ising_free_result(rssn_IsingResultHandle aHandle) ;
...
rssn_ rssn_BincodeBuffer rssn_physics_sim_ising_run_bincode(rssn_BincodeBuffer aBuffer) ;
 ...
 */
rssn_ rssn_Matrix<double> *rssn_physics_sim_linear_elasticity_simulate_cantilever() ;

/*
 Frees the result handles.
 */
rssn_ void rssn_physics_sim_navier_stokes_free_results(rssn_NavierStokesResultHandles aHandles) ;

rssn_ rssn_BincodeBuffer rssn_physics_sim_navier_stokes_run_bincode(rssn_BincodeBuffer aBuffer) ;
...
rssn_ rssn_BincodeBuffer rssn_physics_sim_schrodinger_run_bincode(rssn_BincodeBuffer aBuffer) ;
 ...
 */
rssn_ rssn_Matrix<double> *rssn_physics_sm_simulate_1d_advection() ;

/*
 Simulates the 2D advection-diffusion scenario and returns the results as a Matrix handle (WxH).
 */
rssn_ rssn_Matrix<double> *rssn_physics_sm_simulate_2d_advection() ;

rssn_ char *rssn_physics_sm_solve_advection_1d_json(const char *aInput) ;

rssn_ rssn_BincodeBuffer rssn_physics_sm_solve_advection_2d_bincode(rssn_BincodeBuffer aBuffer) ;
 ...
 */
rssn_ char *rssn_point_compress(const rssn_CurvePoint *aPoint, bool *aIsOddOut) ;
 ...
 */
rssn_ rssn_Expr *rssn_polygamma(const rssn_Expr *aN, const rssn_Expr *aZ) ;

/*
 Frees a polygon mesh.
 */
rssn_ void rssn_polygon_mesh_free(rssn_PolygonMesh *aMesh) ;

/*
 Creates a new polygon mesh.
 */
rssn_ rssn_PolygonMesh *rssn_polygon_mesh_new(const rssn_Vector *aVertices, size_t aVertexCount) ;

/*
 Triangulates a polygon mesh.
 */
rssn_ rssn_PolygonMesh *rssn_polygon_mesh_triangulate(const rssn_PolygonMesh *aMesh) ;
 ...
 */
rssn_ rssn_Expr *rssn_qft_propagator(const rssn_Expr *aP, const rssn_Expr *aM, bool aIsFermion) ;
 ...
 */
rssn_ rssn_Expr *rssn_rotation_2d(const rssn_Expr *aAngle) ;

/*
 Generates a 4x4 3D rotation matrix around the X-axis.
 */
rssn_ rssn_Expr *rssn_rotation_3d_x(const rssn_Expr *aAngle) ;

/*
 Generates a 4x4 3D rotation matrix around the Y-axis.
 */
rssn_ rssn_Expr *rssn_rotation_3d_y(const rssn_Expr *aAngle) ;

/*
 Generates a 4x4 3D rotation matrix around the Z-axis.
 */
rssn_ rssn_Expr *rssn_rotation_3d_z(const rssn_Expr *aAngle) ;

/*
 Generates a 4x4 3D rotation matrix around an arbitrary axis.
 */
rssn_ rssn_Expr *rssn_rotation_axis_angle(const rssn_Vector *aAxis, const rssn_Expr *aAngle) ;
 ...
 */
rssn_ rssn_Expr *rssn_scalar_field_lagrangian(const rssn_Expr *aPhi, const rssn_Expr *aM) ;

/*
 Generates a 3x3 2D scaling matrix.
 */
rssn_ rssn_Expr *rssn_scaling_2d(const rssn_Expr *aSx, const rssn_Expr *aSy) ;
 ...
 */
rssn_ rssn_Expr *rssn_shear_2d(const rssn_Expr *aShx, const rssn_Expr *aShy) ;
 ...
 */
rssn_ rssn_Expr *rssn_translation_2d(const rssn_Expr *aTx, const rssn_Expr *aTy) ;
...
rssn_ rssn_Expr *rssn_z_scaling(const rssn_Expr *aFZ, const rssn_Expr *aA, const char *aOutVar) ;
...
rssn_ rssn_Expr *rssn_z_time_shift(const rssn_Expr *aFZ, const rssn_Expr *aK, const char *aOutVar) ;
