    ...
    fn mul(self, rhs: Self) -> Self::Output {
        Self {
            ...
            v1: self.s.mul_add(rhs.v1, self.v1 * rhs.s) - self.v2 * rhs.b12
                ...
                + self.b23 * rhs.pss
                - self.pss * rhs.b23,
            v2: self.s.mul_add(rhs.v2, self.v2 * rhs.s) + self.v1 * rhs.b12
                - self.v3 * rhs.b23
                - self.b12 * rhs.v1
                + self.b23 * rhs.v3
                - self.b31 * rhs.pss
                + self.pss * rhs.b31,
            v3: self.s.mul_add(rhs.v3, self.v3 * rhs.s) - self.v1 * rhs.b31
                + self.v2 * rhs.b23
                + self.b31 * rhs.v1
                - self.b23 * rhs.v2
                + self.b12 * rhs.pss
            ...
            b12: self.s.mul_add(rhs.b12, self.b12 * rhs.s) + self.v1 * rhs.v2 - self.v2 * rhs.v1
                ...
                - self.b23 * rhs.b31
                + self.b31 * rhs.b23,
            b23: self.s.mul_add(rhs.b23, self.b23 * rhs.s) + self.v2 * rhs.v3
                - self.v3 * rhs.v2
                - self.v1 * rhs.pss
                - self.pss * rhs.v1
                - self.b31 * rhs.b12
