...
impl Multivector3D {
    ...
    pub fn wedge(self, rhs: Self) -> Self {
        ...
        Self {
            ...
            pss: self
                .s
                .mul_add(rhs.pss, self.pss * rhs.s)
                + self.v1 * rhs.b23
                + self.v2 * rhs.b31
                + self.v3 * rhs.b12
                + self.b12 * rhs.v3
...
impl std::ops::Mul for Multivector3D {
    ...
    fn mul(self, rhs: Self) -> Self::Output {
        ...
        Self {
            ...
            b12: self
                .s
                .mul_add(rhs.b12, self.b12 * rhs.s)
                + self.v1 * rhs.v2
                - self.v2 * rhs.v1
                + self.v3 * rhs.pss
                + self.pss * rhs.v3
            ...
            b23: self
                .s
                .mul_add(rhs.b23, self.b23 * rhs.s)
                + self.v2 * rhs.v3
                - self.v3 * rhs.v2
                + self.v1 * rhs.pss
                + self.pss * rhs.v1
            ...
            b31: self
                .s
                .mul_add(rhs.b31, self.b31 * rhs.s)
                + self.v3 * rhs.v1
                - self.v1 * rhs.v3
                + self.v2 * rhs.pss
                + self.pss * rhs.v2
