...
pub fn bessel_y1(x: f64) -> f64 {
    ...
    if x < 8.0 {
        let y = x * x;
        let ans1 = x * (-0.4900604943e13 + y * (0.1275274390e13
            + y * (-0.5153438139e11 + y * (0.7349264551e9
            + y * (-0.4237922726e7 + y * 0.8511937935e4)))));
        let ans2 = 0.2499580570e14 + y * (0.4244419664e12
...
pub fn bessel_i0(x: f64) -> f64 {
    ...
    if ax < 3.75 {
        ...
        let y = 3.75 / ax;
        (ax.exp() / ax.sqrt()) * (0.39894228 + y * (0.01328592 + y * (0.00225319
...
pub fn laguerre_l(n: u32, x: f64) -> f64 {
    ...
    for k in 2..=n {
        let l_next = ((2 * k - 1) as f64 - x) * l_curr / k as f64 - (k - 1) as f64 * l_prev / k as f64;
        l_prev = l_curr;
        l_curr = l_next;
    }
    l_curr
