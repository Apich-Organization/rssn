...
pub fn bessel_j0(x: f64) -> f64 {
    ...
    if ax < 8.0 {
        ...
        let ans2 = y.mul_add(
            y.mul_add(
                y.mul_add(
                    y.mul_add(y + 267.853_271_2, 59_272.648_53),
                    9_494_680.718,
                ),
                1_029_532_985.0,
            ),
...
pub fn bessel_j1(x: f64) -> f64 {
    ...
    if ax < 8.0 {
        ...
        let ans2 = y.mul_add(
            y.mul_add(
                y.mul_add(
                    y.mul_add(y + 376.999_139_7, 994_474.339_4),
                    185_833_047.4,
                ),
                230_053_517_800.0,
            ),
...
pub fn bessel_y0(x: f64) -> f64 {
    ...
    if x < 8.0 {
        ...
        let ans2 = y.mul_add(
            y.mul_add(
                y.mul_add(
                    y.mul_add(y + 226.103_024_4, 474_472.647_0),
                    7_189_466.438,
                ),
                745_249_964.8,
            ),
    ...
    if x < 8.0 {
        ...
        let ans2 = y.mul_add(
            y.mul_add(
                y.mul_add(
                    y.mul_add(
                        y.mul_add(y + 354_963.288_5, 102_042.605),
                        22_459_040.0,
                    ),
                    37_336_503_670.0,
                ),
