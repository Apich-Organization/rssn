...
#[no_mangle]
pub extern "C" fn rssn_json_solve(expr_json: *const c_char, var_json: *const c_char) -> *mut c_char {
...
#[no_mangle]
pub extern "C" fn rssn_json_solve_system(equations_json: *const c_char, vars_json: *const c_char) -> *mut c_char {
...
#[no_mangle]
pub extern "C" fn rssn_json_solve_linear_system(system_json: *const c_char, vars_json: *const c_char) -> *mut c_char {
