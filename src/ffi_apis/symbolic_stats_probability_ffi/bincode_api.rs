...
use std::sync::Arc;
use std::os::raw::c_char; // Technically unused here but consistent with other files
...
#[no_mangle]
pub extern "C" fn rssn_bincode_dist_normal(mean_buf: BincodeBuffer, std_dev_buf: BincodeBuffer) -> BincodeBuffer {
...
#[no_mangle]
pub extern "C" fn rssn_bincode_dist_uniform(min_buf: BincodeBuffer, max_buf: BincodeBuffer) -> BincodeBuffer {
...
#[no_mangle]
pub extern "C" fn rssn_bincode_dist_binomial(n_buf: BincodeBuffer, p_buf: BincodeBuffer) -> BincodeBuffer {
...
#[no_mangle]
pub extern "C" fn rssn_bincode_dist_gamma(shape_buf: BincodeBuffer, rate_buf: BincodeBuffer) -> BincodeBuffer {
...
#[no_mangle]
pub extern "C" fn rssn_bincode_dist_beta(alpha_buf: BincodeBuffer, beta_buf: BincodeBuffer) -> BincodeBuffer {
...
#[no_mangle]
pub extern "C" fn rssn_bincode_dist_pdf(dist_buf: BincodeBuffer, x_buf: BincodeBuffer) -> BincodeBuffer {
...
#[no_mangle]
pub extern "C" fn rssn_bincode_dist_cdf(dist_buf: BincodeBuffer, x_buf: BincodeBuffer) -> BincodeBuffer {
    let dist_expr = parse_expr(dist_buf);
    let x_expr = parse_expr(x_buf).unwrap_or(Expr::Constant(0.0));
...
#[no_mangle]
pub extern "C" fn rssn_bincode_dist_mgf(dist_buf: BincodeBuffer, t_buf: BincodeBuffer) -> BincodeBuffer {
    let dist_expr = parse_expr(dist_buf);
