...
/// Output: bool
#[no_mangle]
pub unsafe extern "C" fn rssn_json_graph_is_connected(json: *const std::os::raw::c_char) -> *mut std::os::raw::c_char {
    let graph: Graph<String> = match from_json_string(json) {
        Some(g) => g,
        None => return std::ptr::null_mut(),
    };
...
/// Output: [[usize]]
#[no_mangle]
pub unsafe extern "C" fn rssn_json_graph_strongly_connected_components(json: *const std::os::raw::c_char) -> *mut std::os::raw::c_char {
    let graph: Graph<String> = match from_json_string(json) {
        Some(g) => g,
        None => return std::ptr::null_mut(),
    };
...
#[no_mangle]
pub unsafe extern "C" fn rssn_json_graph_bridges_and_articulation_points(json: *const std::os::raw::c_char) -> *mut std::os::raw::c_char {
    let graph: Graph<String> = match from_json_string(json) {
        Some(g) => g,
        None => return std::ptr::null_mut(),
    };
...
/// Output: f64
#[no_mangle]
pub unsafe extern "C" fn rssn_json_graph_edmonds_karp_max_flow(json: *const std::os::raw::c_char) -> *mut std::os::raw::c_char {
    #[derive(serde::Deserialize)]
    struct Input {
        graph: Graph<String>,
        source: usize,
...
/// Output: f64
#[no_mangle]
pub unsafe extern "C" fn rssn_json_graph_dinic_max_flow(json: *const std::os::raw::c_char) -> *mut std::os::raw::c_char {
    #[derive(serde::Deserialize)]
    struct Input {
        graph: Graph<String>,
        source: usize,
...
/// Output: [(usize, usize)]
#[no_mangle]
pub unsafe extern "C" fn rssn_json_graph_bipartite_maximum_matching(json: *const std::os::raw::c_char) -> *mut std::os::raw::c_char {
    #[derive(serde::Deserialize)]
    struct Input {
        graph: Graph<String>,
        partition: Vec<i8>,
...
#[no_mangle]
pub unsafe extern "C" fn rssn_json_graph_topological_sort(json: *const std::os::raw::c_char) -> *mut std::os::raw::c_char {
    let graph: Graph<String> = match from_json_string(json) {
        Some(g) => g,
        None => return std::ptr::null_mut(),
    };
