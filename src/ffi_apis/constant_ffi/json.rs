...
gen_ffi_json!(rssn_get_speed_of_light_json, crate::constant::get_speed_of_light);
...
gen_ffi_json!(rssn_get_electron_mass_json, crate::constant::get_electron_mass);
...
gen_ffi_json!(rssn_get_proton_mass_kg_json, crate::constant::get_proton_mass_kg);
gen_ffi_json!(rssn_get_neutron_mass_u_json, crate::constant::get_neutron_mass_u);
...
gen_ffi_json!(rssn_get_bohr_magneton_json, crate::constant::get_bohr_magneton);
...
gen_ffi_json!(rssn_get_hartree_energy_json, crate::constant::get_hartree_energy);
gen_ffi_json!(rssn_get_electron_mass_u_json, crate::constant::get_electron_mass_u);
gen_ffi_json!(rssn_get_proton_mass_u_json, crate::constant::get_proton_mass_u);
...
gen_ffi_json!(rssn_get_muon_g_factor_json, crate::constant::get_muon_g_factor);
