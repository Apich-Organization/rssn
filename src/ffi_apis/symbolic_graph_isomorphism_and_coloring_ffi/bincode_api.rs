...
#[no_mangle]
pub unsafe extern "C" fn rssn_bincode_are_isomorphic_heuristic(input_buf: BincodeBuffer) -> BincodeBuffer {
...
#[no_mangle]
pub unsafe extern "C" fn rssn_bincode_chromatic_number_exact(graph_buf: BincodeBuffer) -> BincodeBuffer {
    let graph: Graph<String> = match from_bincode_buffer(&graph_buf) {
        Some(g) => g,
        None => return BincodeBuffer::empty(),
    };
