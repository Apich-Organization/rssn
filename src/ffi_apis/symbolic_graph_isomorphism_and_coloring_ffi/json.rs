...
/// Output: bool
#[no_mangle]
pub unsafe extern "C" fn rssn_json_are_isomorphic_heuristic(json: *const std::os::raw::c_char) -> *mut std::os::raw::c_char {
...
#[no_mangle]
pub unsafe extern "C" fn rssn_json_greedy_coloring(json: *const std::os::raw::c_char) -> *mut std::os::raw::c_char {
...
/// Output: usize
#[no_mangle]
pub unsafe extern "C" fn rssn_json_chromatic_number_exact(json: *const std::os::raw::c_char) -> *mut std::os::raw::c_char {
    let graph: Graph<String> = match from_json_string(json) {
        Some(g) => g,
        None => return std::ptr::null_mut(),
    };
