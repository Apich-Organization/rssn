...
#[no_mangle]
pub unsafe extern "C" fn rssn_num_lagrange_interpolation_json(input_ptr: *const c_char) -> *mut c_char {
...
#[no_mangle]
pub unsafe extern "C" fn rssn_num_cubic_spline_interpolation_json(input_ptr: *const c_char) -> *mut c_char {
