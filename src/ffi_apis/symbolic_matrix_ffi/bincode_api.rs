...
#[no_mangle]
pub extern "C" fn rssn_bincode_matrix_add(m1_buf: BincodeBuffer, m2_buf: BincodeBuffer) -> BincodeBuffer {
...
#[no_mangle]
pub extern "C" fn rssn_bincode_matrix_mul(m1_buf: BincodeBuffer, m2_buf: BincodeBuffer) -> BincodeBuffer {
    let m1: Option<Expr> = from_bincode_buffer(&m1_buf);
    let m2: Option<Expr> = from_bincode_buffer(&m2_buf);
...
#[no_mangle]
pub extern "C" fn rssn_bincode_matrix_solve_linear_system(a_buf: BincodeBuffer, b_buf: BincodeBuffer) -> BincodeBuffer {
