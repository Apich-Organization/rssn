...
#[no_mangle]
pub unsafe extern "C" fn rssn_num_vector_calculus_divergence_bincode(buffer: BincodeBuffer) -> BincodeBuffer {
    ...
    let ffi_res = match res {
        Ok(v) => FfiResult { ok: Some(v), err: None::<String> },
...
#[no_mangle]
pub unsafe extern "C" fn rssn_num_vector_calculus_curl_bincode(buffer: BincodeBuffer) -> BincodeBuffer {
...
#[no_mangle]
pub unsafe extern "C" fn rssn_num_vector_calculus_laplacian_bincode(buffer: BincodeBuffer) -> BincodeBuffer {
