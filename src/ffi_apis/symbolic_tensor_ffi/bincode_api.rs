...
#[no_mangle]
pub extern "C" fn rssn_bincode_tensor_add(t1_buf: BincodeBuffer, t2_buf: BincodeBuffer) -> BincodeBuffer {
...
#[no_mangle]
pub extern "C" fn rssn_bincode_tensor_scalar_mul(t_buf: BincodeBuffer, scalar_buf: BincodeBuffer) -> BincodeBuffer {
...
#[no_mangle]
pub extern "C" fn rssn_bincode_tensor_outer_product(t1_buf: BincodeBuffer, t2_buf: BincodeBuffer) -> BincodeBuffer {
    let t1: Option<Tensor> = from_bincode_buffer(&t1_buf);
    let t2: Option<Tensor> = from_bincode_buffer(&t2_buf);
