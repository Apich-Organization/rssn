...
#[no_mangle]
pub extern "C" fn rssn_json_tensor_add(t1_json: *const c_char, t2_json: *const c_char) -> *mut c_char {
...
#[no_mangle]
pub extern "C" fn rssn_json_tensor_scalar_mul(t_json: *const c_char, scalar_json: *const c_char) -> *mut c_char {
...
#[no_mangle]
pub extern "C" fn rssn_json_tensor_outer_product(t1_json: *const c_char, t2_json: *const c_char) -> *mut c_char {
    let t1: Option<Tensor> = from_json_string(t1_json);
    let t2: Option<Tensor> = from_json_string(t2_json);
...
#[no_mangle]
pub extern "C" fn rssn_json_tensor_contract(t_json: *const c_char, axis1: usize, axis2: usize) -> *mut c_char {
    let t: Option<Tensor> = from_json_string(t_json);
