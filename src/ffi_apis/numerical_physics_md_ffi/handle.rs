...
#[unsafe(no_mangle)]
pub const extern "C" fn rssn_num_md_boltzmann_constant_si() -> f64 {
    physics_md::BOLTZMANN_CONSTANT_SI
}

/// Returns Avogadro's number.
#[unsafe(no_mangle)]
pub const extern "C" fn rssn_num_md_avogadro_number() -> f64 {
    physics_md::AVOGADRO_NUMBER
}

/// Returns temperature unit for argon in reduced units.
#[unsafe(no_mangle)]
pub const extern "C" fn rssn_num_md_temperature_unit_argon() -> f64 {
