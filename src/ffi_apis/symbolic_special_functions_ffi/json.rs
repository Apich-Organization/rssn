...
pub unsafe extern "C" fn rssn_json_beta(
    ...
    match (a, b) {
        | (Some(val_a), Some(val_b)) => to_json_string(&special_functions::beta(val_a, val_b)),
        | _ => std::ptr::null_mut(),
    }
}
...
pub unsafe extern "C" fn rssn_json_polygamma(
    ...
    match (n, z) {
        | (Some(n), Some(z)) => to_json_string(&special_functions::polygamma(&n, &z)),
        | _ => std::ptr::null_mut(),
    }
}
...
pub unsafe extern "C" fn rssn_json_bessel_j(
    ...
    match (order, arg) {
        | (Some(o), Some(a)) => to_json_string(&special_functions::bessel_j(&o, &a)),
        | _ => std::ptr::null_mut(),
    }
}
...
pub unsafe extern "C" fn rssn_json_bessel_y(
    ...
    match (order, arg) {
        | (Some(o), Some(a)) => to_json_string(&special_functions::bessel_y(&o, &a)),
        | _ => std::ptr::null_mut(),
    }
}
...
pub unsafe extern "C" fn rssn_json_bessel_i(
    ...
    match (order, arg) {
        | (Some(o), Some(a)) => to_json_string(&special_functions::bessel_i(&o, &a)),
        | _ => std::ptr::null_mut(),
    }
}
...
pub unsafe extern "C" fn rssn_json_bessel_k(
    ...
    match (order, arg) {
        | (Some(o), Some(a)) => to_json_string(&special_functions::bessel_k(&o, &a)),
        | _ => std::ptr::null_mut(),
    }
}
...
pub unsafe extern "C" fn rssn_json_legendre_p(
    ...
    match (degree, arg) {
        | (Some(d), Some(a)) => to_json_string(&special_functions::legendre_p(&d, a)),
        | _ => std::ptr::null_mut(),
    }
}
...
pub unsafe extern "C" fn rssn_json_laguerre_l(
    ...
    match (degree, arg) {
        | (Some(d), Some(a)) => to_json_string(&special_functions::laguerre_l(&d, a)),
        | _ => std::ptr::null_mut(),
    }
}
...
pub unsafe extern "C" fn rssn_json_hermite_h(
    ...
    match (degree, arg) {
        | (Some(d), Some(a)) => to_json_string(&special_functions::hermite_h(&d, a)),
        | _ => std::ptr::null_mut(),
    }
}
...
pub unsafe extern "C" fn rssn_json_chebyshev_t(
    ...
    match (n, x) {
        | (Some(n), Some(x)) => to_json_string(&special_functions::chebyshev_t(&n, &x)),
        | _ => std::ptr::null_mut(),
    }
}
...
pub unsafe extern "C" fn rssn_json_chebyshev_u(
    ...
    match (n, x) {
        | (Some(n), Some(x)) => to_json_string(&special_functions::chebyshev_u(&n, &x)),
        | _ => std::ptr::null_mut(),
    }
}
