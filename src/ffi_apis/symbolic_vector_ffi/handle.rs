...
#[no_mangle]
pub extern "C" fn rssn_vector_magnitude_handle(v: *const Vector) -> *mut crate::symbolic::core::Expr {
    let v_ref = unsafe { &*v };
...
#[no_mangle]
pub extern "C" fn rssn_vector_dot_handle(v1: *const Vector, v2: *const Vector) -> *mut crate::symbolic::core::Expr {
