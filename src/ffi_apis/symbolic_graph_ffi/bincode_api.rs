...
#[no_mangle]
pub unsafe extern "C" fn rssn_bincode_graph_adjacency_matrix(graph_buf: BincodeBuffer) -> BincodeBuffer {
...
#[no_mangle]
pub unsafe extern "C" fn rssn_bincode_graph_laplacian_matrix(graph_buf: BincodeBuffer) -> BincodeBuffer {
    let graph: Graph<String> = match from_bincode_buffer(&graph_buf) {
        Some(g) => g,
        None => return BincodeBuffer::empty(),
    };
