...
#[no_mangle]
pub extern "C" fn rssn_json_differentiate(expr_json: *const c_char, var: *const c_char) -> *mut c_char {
...
#[no_mangle]
pub extern "C" fn rssn_json_limit(expr_json: *const c_char, var: *const c_char, point_json: *const c_char) -> *mut c_char {
    let expr: Option<Expr> = from_json_string(expr_json);
...
#[no_mangle]
pub extern "C" fn rssn_json_find_poles(expr_json: *const c_char, var: *const c_char) -> *mut c_char {
    let expr: Option<Expr> = from_json_string(expr_json);
    let var_str = unsafe {
        if var.is_null() { None } else { std::ffi::CStr::from_ptr(var).to_str().ok() }
    };
...
#[no_mangle]
pub extern "C" fn rssn_json_calculate_residue(expr_json: *const c_char, var: *const c_char, pole_json: *const c_char) -> *mut c_char {
    let expr: Option<Expr> = from_json_string(expr_json);
...
#[no_mangle]
pub extern "C" fn rssn_json_find_pole_order(expr_json: *const c_char, var: *const c_char, pole_json: *const c_char) -> usize {
    let expr: Option<Expr> = from_json_string(expr_json);
    let pole: Option<Expr> = from_json_string(pole_json);
    let var_str = unsafe {
        if var.is_null() { None } else { std::ffi::CStr::from_ptr(var).to_str().ok() }
...
#[no_mangle]
pub extern "C" fn rssn_json_substitute(expr_json: *const c_char, var: *const c_char, replacement_json: *const c_char) -> *mut c_char {
    let expr: Option<Expr> = from_json_string(expr_json);
...
#[no_mangle]
pub extern "C" fn rssn_json_path_integrate(expr_json: *const c_char, var: *const c_char, contour_json: *const c_char) -> *mut c_char {
    let expr: Option<Expr> = from_json_string(expr_json);
...
#[no_mangle]
pub extern "C" fn rssn_json_evaluate_at_point(expr_json: *const c_char, var: *const c_char, value_json: *const c_char) -> *mut c_char {
    let expr: Option<Expr> = from_json_string(expr_json);
