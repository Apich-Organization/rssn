...
use crate::physics::physics_cnm::{self, HeatEquationSolverConfig};
...
#[no_mangle]
pub unsafe extern "C" fn rssn_physics_cnm_solve_heat_2d_bincode(buffer: BincodeBuffer) -> BincodeBuffer {
