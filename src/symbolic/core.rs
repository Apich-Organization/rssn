...
impl fmt::Display for Expr {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        match self {
            ...
            Expr::AsymptoticExpansion(a, b, c, d) => write!(f, "asymptotic_expansion({}, {}, {}, {})", a, b, c, d),
            ...
            Expr::VolumeIntegral { scalar_field, volume } => write!(f, "volume_integral({}, {})", scalar_field, volume),
            Expr::SurfaceIntegral { vector_field, surface } => write!(f, "surface_integral({}, {})", vector_field, surface),
