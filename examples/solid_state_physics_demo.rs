...
fn main() {
    ...
    let a1 = Vector::new(Expr::new_variable("a"), Expr::Constant(0.0), Expr::Constant(0.0));
    let a2 = Vector::new(Expr::Constant(0.0), Expr::new_variable("a"), Expr::Constant(0.0));
    let a3 = Vector::new(Expr::Constant(0.0), Expr::Constant(0.0), Expr::new_variable("a"));
    ...
    println!("a2 x a3: ({}, {}, {})", a2_cross_a3.x, a2_cross_a3.y, a2_cross_a3.z);
